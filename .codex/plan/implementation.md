...
| 1 | HTTP client | In progress | `feature/http-client` | 44 tests passed; build passed | Awaiting commit and push |
| 2 | Profile read | Not started | `feature/profile-read` | Pending | Next feature |
