...
| 2 | Diary read | In progress | `feature/diary-read` | Temporary live/offline checks passed; build passed | Implemented locally without permanent test files per user request; awaiting PR delivery |
