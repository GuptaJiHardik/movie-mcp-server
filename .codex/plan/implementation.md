...
| 1 | SQLite storage | In progress | `feature/sqlite-storage` | 28 tests passed; build passed | Awaiting commit and push |
| 1 | HTTP client | Not started | `feature/http-client` | Pending | Next feature |
